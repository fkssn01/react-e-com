    ...
    <div className="page">
     <div className="container">
      ...
      <form className="auth-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button className="btn btn-primary btn-large" type="submit">{mode === 'signup' ? 'signUp' : 'Login'}</button>
      </form>

      <div className="auth-switch">
        { mode === 'signup' ? (<p>Already have an account <span className="auth-link" onClick={() => setMode("login")}>Login</span></p>) : (<p>
